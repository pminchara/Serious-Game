...
private:
	...
	void initVAO()
	{
		...
		//set vertextattribpointers and enable(input assembly)
		//Position
		...
		//color
		//GLuint attribLocColor = glGetAttribLocation(core_program, "vertex_color");
		glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(Vertex), (GLvoid*)offsetof(Vertex, color));
		glEnableVertexAttribArray(1);

		//texcoord
		//GLuint attribLocTexcoord = glGetAttribLocation(core_program, "vertex_texcoord");
		glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, sizeof(Vertex), (GLvoid*)offsetof(Vertex, texcoord));
		glEnableVertexAttribArray(2);

		//Normal
		//GLuint attribLocNormal = glGetAttribLocation(core_program, "vertex_normal");
